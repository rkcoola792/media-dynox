...
const Dropdown = ({reference}) => {
  ...
  return (
    <div className="dropdown w-[380px] p-8 shadow-lg flex flex-col gap-8 rounded-sm transition duration-450 ease-out hover:ease-in ">
      ...
      ></Item>
      <Item
        subheading={reference=="Service"?"Learn, share and connect with other users.":"The brain behind the brilliance "}
        title={reference=="Service"?"Technology":"Team"}
        img={reference=="Service"?"/technology.webp":"/team.webp"}
        color="bg-blue-100"
      ></Item>
      <Item
        subheading={reference=="Service"?"Learn how to sign up, install and use our products.":"Fueling innovation, one step at a time"}
        title={reference=="Service"?"Business":"Work"}
        img={reference=="Service"?"/business.webp":"work.webp"}
        color="bg-green-100"
      ></Item>
      <Item
        subheading={reference=="Service"?"Learn, share and connect with other users.":"Come be a part of our team!"}
